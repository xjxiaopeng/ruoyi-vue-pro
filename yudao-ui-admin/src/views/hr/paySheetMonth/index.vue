  ...
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button type="primary" plain icon="el-icon-plus" size="mini" @click="handleAdd"
                   v-hasPermi="['hr:pay-sheet-month:create']">新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="warning" plain icon="el-icon-download" size="mini" @click="handleExport" :loading="exportLoading"
                   v-hasPermi="['hr:pay-sheet-month:export']">导出</el-button>
      </el-col>
      <right-toolbar :showSearch.sync="showSearch" @queryTable="getList"></right-toolbar>
    </el-row>

    <!-- 列表 -->
    <el-table v-loading="loading" :max-height="tableHeight" :data="list">
      ...
      <el-table-column label="操作" align="center" fixed="right" width="160" class-name="small-padding fixed-width">
        <template v-slot="scope"  style="margin: 0;padding: 0;text-align: left">
          <el-button size="mini" type="text" icon="el-icon-edit" @click="handleUpdate(scope.row)"
                     v-hasPermi="['hr:pay-sheet-month:update']">修改</el-button>
          <el-button size="mini" type="text" icon="el-icon-delete" @click="handleDelete(scope.row)"
                     v-hasPermi="['hr:pay-sheet-month:delete']">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
    <!-- 分页组件 -->
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" v-dialogDrag append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="工资表名称" prop="wageName">
          <el-input v-model="form.wageName" placeholder="请输入工资表名称" />
        </el-form-item>
        <el-form-item label="姓名" prop="nickname">
...
<script>
import { createPaySheetMonth, updatePaySheetMonth, deletePaySheetMonth, getPaySheetMonth, getPaySheetMonthPage, exportPaySheetMonthExcel } from "@/api/hr/paySheetMonth";
